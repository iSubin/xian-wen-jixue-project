...
class AppConfig:
    ...
    prompt_file: str = "src/main/python/xianwen/prompt.md"
...
def to_llm_config(settings: Settings) -> "LLMConfigDataclass":
    from src.main.python.xianwen.llm.llm import LLMConfig as LLMConfigDataclass
